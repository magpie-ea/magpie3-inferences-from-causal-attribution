    ...
    <InstructionScreen :title="'Instructions'">
      <p>
        ...
        <strong>Blue marbles are released with a probability of
          {{ bias == "blue" ? "90" : "10" }}%</strong> from the left compartment, meaning that the released marble will
        be
        ...
        <strong>Red marbles are released with a probability of
          {{ bias == "blue" ? "10" : "90" }}%</strong> from the right compartment, meaning that the released marble will
        be
