<template>
  ...
  <Experiment title="causal-implicature-variation">
    ...
    <Screen>
      <Slide>
        <p>
          You see two islanders, a follower of religion 1 who regards red as impure, and a follower of religion 2 who
          regards blue as impure, come up to the machine.
          One of them presses the Start button to activate the machine.
        ...
        <p>
          Given the situation, decide how likely is the follower of <b>religion 1</b>, who regards red as impure, to say
          the following following:<br>

          <b>`The machine made sound A because a red marble was released’.</b>
          <RatingInput
              left="very unlikely"
              right="very likely"
          ...
          <b>`The machine made sound A because a blue marble was released’.</b>
          <RatingInput
              left="very unlikely"
              right="very likely"
        ...
        <p>
          ...
          say the following following:<br>
