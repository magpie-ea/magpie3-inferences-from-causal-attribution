  ...
  <Experiment title="CausalAttribInference">
    ...
    <InstructionScreen :title="'Instructions'">
      <p>
        ...
        <br>
        <strong>Blue marbles are released with a probability of {{ stat_norm == "blue" ? "90" : "10" }}%</strong> from the
        left compartment, meaning that the released marble will tend to be {{ stat_norm == "blue" ? "blue" : "yellow" }} 9
        out of 10 times and {{ stat_norm == "blue" ? "yellow" : "blue" }} 1 out of 10 times.
        <br>
        <strong>Red marbles are released with a probability of {{ stat_norm == "blue" ? "10" : "90" }}%</strong> from the
        right compartment, meaning that the released marble will tend to be {{ stat_norm == "blue" ? "green" : "red" }} 9 out
    ...
    <InstructionScreen :title="'Further Instructions'">
      ...
      <p>
        ...
        So, the machine will release a <span class="red">red</span> marble with {{ bias == "blue" ? "10" : "90" }}% probability and a <span class="blue">blue</span> marble with {{ bias == "blue" ? "90" : "10" }}% probability, no matter who presses the Start button.
